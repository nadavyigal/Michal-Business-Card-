...
const RECOMMENDATIONS = [
  {
    ...
    title: 'סמנכ"ל, מנהלת תחום תביעות רכוש וסיכונים מיוחדים, כלל חברה לביטוח',
      ...
      >
        ...
        <div className="section-inner" style={{ maxWidth: 1100, margin: '0 auto', padding: '100px 48px', position: 'relative' }}>
          ...
          <div className="about-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 52, marginBottom: 64 }}>
            <Reveal delay={160}>
              <div style={{ display: 'grid', gap: 20 }}>
                ...
                <p style={{ fontSize: 17, lineHeight: 1.85, color: 'rgba(248,240,231,0.66)' }}>
                  בעידן שבו ה-AI מחליף את הפעולות הטכניות והלוגיות, היתרון האנושי המרכזי שנותר למנהל הוא יכולת ההתמודדות שלו. הערך של מנהל נמדד היום ביכולת שלו לווסת את המערכת הפנימית שלו כדי לייצר חדות, ביטחון וביצועים בשטח.
                </p>
                <p style={{ fontSize: 17, lineHeight: 1.85, color: 'rgba(248,240,231,0.66)' }}>
                  מנהלים שלא <span style={ABOUT_HIGHLIGHT}>יפתחו מיומנויות של ויסות וחדות ניהולית מול העובדים</span> שלהם, ימצאו את עצמם שחוקים ומנוהלים על ידי הסטרס.
                </p>
              </div>
            </Reveal>
            <Reveal delay={240}>
          ...
          <Reveal delay={380}>
            ...
            >
              <div style={{ display: 'grid', gap: 14, color: 'rgba(248,240,231,0.72)' }}>
                <p style={{ fontSize: 16, lineHeight: 1.85 }}>
                  התוכנית מבוססת על מודל ר.ו.ב שפיתחתי (ראיה, ויסות, בהירות/ביצוע) – פרוטוקול עבודה המלמד מנהלים איך לפעול ברגע האמת:
                </p>
                <ul style={{ margin: 0, paddingInlineStart: 22, display: 'grid', gap: 12, fontSize: 16, lineHeight: 1.85 }}>
                  <li>
                    <strong>ראיה:</strong> זיהוי מדויק של המתרחש "מתחת לפני השטח" – ברמה האישית, הבינאישית (אצל העובד) והארגונית.
                  </li>
                  <li>
                    <strong>ויסות:</strong> ניהול רגשות ותגובות אוטומטיות בזמן אמת, המאפשר מעבר מפעולה 'תגובתית' לבחירה מודעת ושקולה.
                  </li>
                  <li>
                    <strong>בהירות / ביצוע:</strong> קבלת החלטות מתוך שקט פנימי ובחירת הפעולה האפקטיבית ביותר לביצוע בשטח.
                  </li>
                </ul>
              </div>
            </div>
